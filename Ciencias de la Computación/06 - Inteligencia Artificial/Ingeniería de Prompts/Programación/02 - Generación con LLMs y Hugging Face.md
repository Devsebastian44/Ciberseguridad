...
- **Generar código** en múltiples lenguajes (Python, JavaScript, SQL)
...
```
Escribe un código en Python para encontrar la mediana 
de una lista de números. Explica tu razonamiento paso 
a paso antes de escribir el código.
```
...
**Plataforma y comunidad** de Machine Learning Open Source que facilita el acceso a modelos preentrenados.
...
- **Integración** con Google AI Studio, OpenAI
