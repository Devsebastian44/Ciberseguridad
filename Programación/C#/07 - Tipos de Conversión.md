## Métodos de Escritura en Consola
...
|---|---|---|
|`int.Parse()`|String a **int**|`int.Parse("123")`|
|`double.Parse()`|String a **double**|`double.Parse("3.14")`|
|`decimal.Parse()`|String a **decimal**|`decimal.Parse("99.99")`|
|`bool.Parse()`|String a **bool**|`bool.Parse("true")`|
|`Convert.ToInt32()`|Conversión a **int**|`Convert.ToInt32("123")`|
