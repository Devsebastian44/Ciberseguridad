...
**Cambiar color de fondo cada segundo:**
...
En JavaScript, **`value`** es una propiedad que se utiliza para **obtener o establecer el valor de ciertos elementos HTML**, principalmente de formularios como `<input>`, `<textarea>`, `<select>`.
